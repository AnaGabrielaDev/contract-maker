const fieldsValidation = {
  nameLocador: "Nome do Locador",
  nacionalidadeLocador: "Nacionalidade do Locador",
  profissaoLocador: "Profissão do Locador",
  rgLocador: "RG do Locador",
  cpfLocador: "CPF do Locador",
  addressLocador: "Endereço do Locador",
  numAddressLocador: "Numero do Endereço do Locador",
  neighborhoodLocador: "Bairro do Locador",
  cepLocador: "CEP do Locador",
  cityLocador: "Cidade do Locador",
  stateLocador: "Estado do Locador",

  nameLocatario: "Nome do Locatario",
  nacionalidadeLocatario: "Nacionalidade do Locatario",
  profissaoLocatario: "Profissão do Locatario",
  rgLocatario: "RG do Locatario",
  cpfLocatario: "CPF do Locatario",
  addressLocatario: "Endereço do Locatario",
  numAddressLocatario: "Numero do Endereço do Locatario",
  neighborhoodLocatario: "Bairro do Locatario",
  cepLocatario: "CEP do Locatario",
  cityLocatario: "Cidade do Locatario",
  stateLocatario: "Estado do Locatario",

  nameFiador: "Nome do Fiador",
  nacionalidadeFiador: "Nacionalidade do Fiador",
  profissaoFiador: "Profissao do Fiador",
  rgFiador: "RG do Fiador",
  cpfFiador: "CPF do Fiador",
  addressFiador: "Endereço do Fiador",
  numAddressFiador: "Numero do Endereço do Fiador",
  neighborhoodFiador: "Bairro do Fiador",
  cepFiador: "CEP do Fiador",
  cityFiador: "Cidade do Fiador",
  stateFiador: "Estado do Fiador"
}
function validation() {
  ...
  for(const field of fields){
    ...
    if (value === ""){
      var fieldName = fieldsValidation[field.getAttribute("name")];
...
function generatePdf() {
  const validationtest = validation();
  if (!validationtest){
    return;
  }
  ...
  if(metodoGarantia === "fiador"){
    ...
    var nacionalidadeFiador = document.querySelector('#nacionalidadeLocador').value;
    ...
    var numAddressFiador = document.querySelector('#numAddressFiador').value;
    var complementoAddressFiador = document.querySelector('#complementoAddressFiador').value;
    var neighborhoodFiador = document.querySelector('#neighborhoodFiador').value;
    var cepFiador = document.querySelector('#cepFiador').value;
    var cityFiador = document.querySelector('#cityFiador').value;
    var stateFiador = document.querySelector('#stateFiador').value;
  }
  ...
  let restante = [
    {
            ...
            2.2 O LOCATÁRIO obriga por si e demais dependentes a cumprir e a fazer cumprir integralmente as disposições legais sobre o Condomínio, a sua Convenção e o seu Regulamento Interno.`,
          {
            ...
            `\n3.1 O prazo da locação é de "_______" meses, iniciando-se em ${dataAtualSelected ? dataAtual : txtNovaData} com término em ${docValidade}, independentemente de aviso, notificação ou interpelação judicial extrajudicial. \n
